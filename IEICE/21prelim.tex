...
$X$ ab infinite set of variable symbols such that $\Sigma \cap X = \emptyset$.
...
A pattern $p$ is said to be \textit{regular} if each variable symbol appears at most one in $p$.
