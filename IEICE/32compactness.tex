...
\begin{proof}
W.l.o.g., we suppose that $\sharp Q = k$ holds. Otherwise, a regular pattern that is already included in $Q$ should be added to $Q$ repeatedly until the condition $\sharp Q = k$ is satisfied.
