...
%\hrule
%\smallskip
%\hfill Edited by Takayoshi Shoudai on 2024-05-16 (1st version).
...
\begin{figure}[t]
  \begin{center}
    ...
    \caption{Case $|w_{\prime\prime}| + 3 \le |w^{\prime}| \le 2|w^{\prime\prime}| - 1$ of (iii) of \textit{Claim} 2 (Lemma~\ref{追加部分})}\label{w1+3}
  \end{center}
\end{figure}
