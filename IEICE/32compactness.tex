...
In the case of $a\in A\cap B'$ and $b\in A\cap B$, this claim is similarly proven. (\textit{End of Proof of Claim})
...
For any $a'b' \in A'\cdot B'$ and $q \in Q_{2}^{(\cdot,\cdot)}$, if $a' = \sigma_{B}(q)$ and $b' = \sigma_{A}(q)$ hold, by considering the duplicate numbers $\ell_{A}$ and $\ell_{B}$, we have the following inequality:
\begin{align*}
