...
Obviously, we remark that $D = \{ a_{1}b_{1}, a_{2}b_{2}, a_{3}y\}$ and $D = \{ a_{1}b_{1}, a_{2}b_{2}, yb_{3}\}$ {\color{red} satisfy} that $a_{i}\neq a_{3}$ and $b_{i}\neq b_{3}$ for $i=1,2$, respectively.
}
...
\begin{lem}\label{lem:3consts_ii}
  Let $\Sigma$ be an alphabet $\sharp\Sigma \ge 3$, $p,~q$ regular patterns {\color{red} in $\RPat_{\Sigma\cup X}$ and
...
\begin{lem}\label{lem:3consts_iii}
  Let $\Sigma$ be an alphabet with $\sharp\Sigma \ge 3$, $p,~q$ regular pattern {\color{red}in $\RPat_{\Sigma\cup X}$} and
