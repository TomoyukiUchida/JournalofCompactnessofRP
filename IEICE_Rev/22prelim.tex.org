...
From Lemma~\ref{Sato1:Lemma10}, the following lemma holds.
\begin{thm}[Sato et al.\cite{Sato1}]\label{定理10}\label{Sato1:Theorem10}
...
Example~\ref{counter-example4Theorem10} in~\cite{Sato1} is given as a counter-example of Theorem~\ref{Sato1:Theorem10}.%\ref{定理10}.
