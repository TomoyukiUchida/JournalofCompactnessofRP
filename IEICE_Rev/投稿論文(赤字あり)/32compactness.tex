...
\begin{lem}\label{lem:addpart}
  ...
  $y$ is a variable symbol in $X$ that {\color{red}occurs in neither $p$ nor $q$}.}
...
This contradicts the assumption that $p$ and $q$ satisfy 
  $p\not\preceq q$.}
Similarly, we can show that {\color{red}the other three cases} of (2) and (1') also contradict the assumption.
