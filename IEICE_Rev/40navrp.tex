...
We define the compactness with respect to {\color{red} language} containment for $\NAVRPkei$ in a similar way as {\color{red}$\RPatkei$}.%Def.\ref{def:compactness}.
 For any $\NAV$ regular pattern $p \in \NAVRP$ and any set $Q \in \NAVRPkei$ with $k~(k\geq 1)$,
  the set $\NAVRPkei$ {\color{red} is said} to have {\it compactness with respect to {\color{red}language} containment}
...
Then, $\NAVRPkei$ does not have compactness with respect to {\color{red} language }containment.
\end{lem}
\begin{proof}
...
Then, the set $\NAVRPLkei$ has compactness with respect to {\color{red} language }containment.
\end{thm}