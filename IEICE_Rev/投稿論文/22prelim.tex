...
{\color{red} The following example~\ref{counter-example4Theorem11} in \cite{Sato1} illustrates the failure of Theorem~\ref{Sato1:Theorem11} {\color{red}under $\sharp\Sigma \leq 2k$}, in accordance with Lemma~\ref{Sato1:Lemma13}.} 
