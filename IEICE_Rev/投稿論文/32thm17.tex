...
\begin{proof}
    ...
    By (i), we have {\color{red}$\{p\} \subseteq L(Q)$}. Thus, $p \preceq q$ for some $q \in Q$.
    ...
    Since $k \geq 3$, {\color{red} $2k-1 \geq k+2$}.
...
{\color{red}the following corollary holds}.


\begin{col}\label{Col18}
    %Let $k \geq 3$, $\sharp\Sigma \geq 2k-1$ and $P \in \RPatplus$.
    {\color{red}Let $k$ be an integer with $k \geq 3$ and $\Sigma$ an alphabet with $\sharp\Sigma \geq 2k-1$.
...
{\color{red}From Theorem~\ref{Theorem17},
we have the following theorem.}

\begin{thm}\label{Theorem5}
    %Let $k \geq 3$ and $\sharp\Sigma \geq 2k-1$.
    {\color{red}Let $k$ be an integer with $k \geq 3$ and $\Sigma$ an alphabet with $\sharp\Sigma \geq 2k-1$.}
    Then, {\color{red}$\RPatkei_{\Sigma\cup X}$} has compactness with respect to {\color{red} language} containment.
\end{thm}
...
\begin{lem}[Sato et al.\cite{Sato1}]\label{Sato1:Lemma19}
    ...
    {\color{red} Let $k$ be an integer with $k \geq 3$ and $\Sigma$ an alphabet with $\sharp\Sigma \leq 2k-2$.}
    Then, {\color{red}$\RPatkei_{\Sigma\cup X}$} does not have compactness with respect to {\color{red} language} containment.
\end{lem}
...
\begin{thm}\label{Theorem21}
    {\color{red} Let $\Sigma$ be an alphabet with $\sharp\Sigma \geq 4$.
...
\begin{col}
    ...
    $S_{2}(P)$ is a characteristic set for $L(P)$ within {\color{red}$\RPatL^{2}_{\Sigma\cup X}$}.
\end{col}

\begin{col}
    {\color{red} Let $\Sigma$ be an alphabet with $\sharp\Sigma \geq 4$}.
Then, {\color{red}$\RPat^{2}_{\Sigma\cup X}$} has compactness with respect to {\color{red} language} containment.
\end{col}
