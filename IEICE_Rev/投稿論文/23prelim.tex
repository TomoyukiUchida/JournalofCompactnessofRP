...
\begin{proof}
  ...
  \begin{itemize}
  \item $|w| = 0,1,2,\mbox{\color{red}~or~}3$: it is straightforward to observe that $\pair{b}{c} \in \{\pair{a}{d}, \pair{d}{a}\}$ holds.
...
Without loss of generality, {\color{red} we assume that $|w| \geq |w^{\prime}|$ holds, since the case $|w| < |w^{\prime}|$ similarly leads to} the same conclusion that $\pair{a}{d} \in \{\pair{b}{c}, \pair{c}{b}\}$ holds.
\begin{itemize}
