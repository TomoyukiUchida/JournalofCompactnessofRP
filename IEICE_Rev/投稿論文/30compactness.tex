...
However, we can see that $p\{x:=a_1b_1\}\preceq q$, $p\{x:=a_2b_2\}\preceq q$ and $p\{x:=a_3b_3\}\preceq q$ hold, 
since
...
%{\color{red}In Subsecs.~\ref{subsec:d3a}--\ref{subsec:d3c}, 
%we consider a regular pattern $q$ which minimally support $D$ for $p$}.
...
%
%{\color{red} We assume that $p\not\preceq q$ holds in order to derive a contradiction.}
%
%---------
