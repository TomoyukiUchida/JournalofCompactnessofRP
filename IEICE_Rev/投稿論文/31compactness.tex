...
Moreover, {\color{red}both }$wa_{2}b_{2}w^{\prime}a_{3}$ and $w^{\prime}a_{3}$ are prefixes of $p_{2}$ from (1') and (2').
Hence, there exist constant {\color{red}strings} $w_{1}$ and $w_{2}$ such that $w^{\prime}=w_{1}w$, $w^{\prime}=ww_{2}$ and $|a_{2}b_{2}w_{1}|=|w_{2}a_{3}|+1$.
...
there exists a constant symbol $w_{2}$ such that $w=w_{2}w^{\prime}$ and {\color{red}$w_{1}a_{2}b_{2}w^{\prime}=a_{1}b_{1}w_{2}w^{\prime}$}.
Hence, $w_{1}=a_{1}$.
Thus, $a_{1}=a_{3}$.
This contradicts the assumption of $a_{1}\ne a_{3}$.
%
...
Moreover, since there exists a constant string $w_{2}$ such that $w=w_{2}w^{\prime}$ and {\color{red}$w_{1}a_{2}b_{2}=a_{1}b_{1}w_{2}$ from (2) and (3)},
...
Hence, $a_{1}=b_{2}$.
Moreover, since {\color{red}both }$b_{2}a_{3}$ and $a_{3}$ is prefixes of $p_{2}$, $b_{2}=a_{3}$.
Thus, $a_{1}=a_{3}$.
This contradicts the assumption of $a_{1} \ne a_{3}$.
%
...
{\color{red}From Theorem \ref{Sato1:Lemma9}, we have $p\preceq q$, since $q_{2}^{\prime}$ contains a variable symbol $y_{1}$.}
{\color{red}
...
\begin{lem}\label{lem:3consts_ii}
  ...
  {\color{red}Let $p$ and $q$} be regular patterns {\color{red} in $\RPat_{\Sigma\cup X}$.
  Define $D=\{ a_{1}b_{1}, a_{2}b_{2}, yb_{3}\} \subsetneq \RPat_{\Sigma\cup X}$
  where $a_{1}\neq a_{2}$, $b_{i}\neq b_{j}$ for {\color{red}$1\leq i<j\leq 3$} with $i\neq j$ and $y$ is a variable symbol in $X$ that {\color{red}appears in neither $p$ nor $q$}.
  Suppose that $p\preceq q$ or that $q$ minimally supports $D$ for $p$.
Then $p \{ x := xy \} \preceq q$.}
\end{lem}
...
\begin{lem}\label{lem:3consts_iii}
 % Let $\Sigma$ be an alphabet with $\sharp\Sigma \ge 3$, 
 {\color{red}Let $\Sigma$ be an alphabet with $\sharp\Sigma \ge 3$}.
 {\color{red}Let $p$ and $q$ be} regular {\color{red}patterns in $\RPat_{\Sigma\cup X}$}.
  {\color{red} Define $D=\{ a_{1}b_{1}, a_{2}b_{2}, a_{3}b_{3}\}\subsetneq \RPat_{\Sigma\cup X}$ where $a_{i} \ne a_{j} \mbox{ and } b_{i} \ne b_{j} \mbox{ with } i\ne j ~{\color{red}(1\le i<j\le 3)}$.
  Suppose that $p\preceq q$ or that $q$ minimally supports $D$ for $p$.
  Then $p \{ x := xy \} \preceq q$.}
\end{lem}
...
%
\item $|w|+1=|w^{\prime}|$: {\color{red} From (1') and (2')}, $wa_{2}b_{2}w^{\prime}a_{3}b_{3}$ and $w^{\prime}a_{3}b_{3}$ are prefixes of $p_{2}$.
If there exists a constant symbol $w_{1}$ such that $w^{\prime}a_{3}b_{3}=ww_{1}a_{3}b_{3}$,
then {\color{red}$b_{2}=a_{3}$} from $wa_{2}b_{2}=ww_{1}a_{3}$.
...
Hence, from $b_{2}=a_{3}$, {\color{red} we have $a_{3}=a_{1}$}.
...
If there exist constant strings $w_{1}$ and $w_{2}$ such that $w^{\prime} = w_{1}w=ww_{2}$, then {\color{red} $a_{3}b_{3}$ is a suffix of $w_{1}$ from $|w_1|=|w_2|$ and $ww_{2}a_{3}b_{3}=wa_{2}b_{2}w_{1}$}.
