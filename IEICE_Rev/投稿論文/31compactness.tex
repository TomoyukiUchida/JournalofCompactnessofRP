...
\begin{lem}\label{lem:3consts_i}
  Let $\Sigma$ be an alphabet with $\sharp\Sigma \ge 3$, {\color{red}$p,q$} regular patterns {\color{red}in $\RPat_{\Sigma\cup X}$} and
  ...
  Then, if $q$ minimally supports $D$ for $p$,
...
\begin{lem}\label{lem:3consts_ii}
  Let $\Sigma$ be an alphabet $\sharp\Sigma \ge 3$, {\color{red}$p,q$} regular patterns {\color{red} in $\RPat_{\Sigma\cup X}$ and
...
\begin{lem}\label{lem:3consts_iii}
  Let $\Sigma$ be an alphabet with $\sharp\Sigma \ge 3$, {\color{red}$p,q$} regular pattern {\color{red}in $\RPat_{\Sigma\cup X}$} and
