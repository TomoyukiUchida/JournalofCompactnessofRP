...
\begin{lem}\label{lem:addpart}
  Let $\Sigma$ be an alphabet with $\sharp\Sigma \ge 3$ and $p,~q$ regular patterns in {\color{red} $\RPat_{\Sigma\cup X}$}.
  {\color{red} Let $D = \{ ya, bc, dy \} \subsetneq \RPat_{\Sigma\cup X}$ 
...
Let $\Sigma$ be an alphabet with $\sharp\Sigma \ge 3$, $p,~q$ regular patterns {\color{red} in $\RPat_{\Sigma\cup X}$ and
...
\begin{lem}\label{lem:oneside_ii}
  {\color{red}Let $\Sigma$ be an alphabet with $\sharp\Sigma \ge 3$, $p,~q$ be regular patterns in $\RPat_{\Sigma\cup X}$ and
