...
From the Lemma \ref{Add-Lemma01} %\ref{追加補題1} 
and Lemma \ref{Sato1:Lemma15}, %\ref{補題15},
...
\begin{thm}\label{Theorem17}%\label{定理17}
...
\begin{proof}
    ...
    By Lemma~\ref{Sato1:Lemma10}, %\ref{補題10}, 
...
From Theorem~\ref{Theorem17}, %\ref{定理17}, 
...
From Theorem~\ref{Theorem17}%\ref{定理17}
 and Lemma~\ref{Sato1:Lemma19}, %\ref{補題19},
...
\begin{thm}\label{Theorem21}%\label{補題21}
...
%The next example is a counter-example of Theorem~\ref{Theorem21}%\ref{補題21}.
...
From Theorem~\ref{Theorem21}, %\ref{補題21}, 
