...
%$p\{x^{\prime}:=a_1b_1\}=cb_3a_1b_1b_3a_1b_1a_1b_1b_3a_2c=q\{x:=cb_3a_1b_1,y:=b_3a_2c\}$,
%$p\{x^{\prime}:=a_2b_2\}=cb_3a_1b_1b_3a_1b_1a_1b_1b_3a_2c=q\{x:=c,y:=b_2a_1b_1b_3a_2c\}$,
%and $p\{x^{\prime}:=a_3b_3\}=cb_3a_1b_1b_3a_1b_1a_1b_1b_3a_2c=q\{x:=cb_3a_1b_1b_3a_3,y:=c\}$ hold.
...
Let $\Sigma$ be an alphabet with $\sharp\Sigma \ge 3$, $p,q$ regular patterns on $\Sigma$.
