...
\subsection{$|D| = 2$}\label{subsec:d2}
...
Therefore, let $p=p_{1}xp_{2}$, where $p_{i}$ ($i=1,2$) is an empty symbol or a regular pattern on $\Sigma\cup X$, and $x$ is a variable symbol.
