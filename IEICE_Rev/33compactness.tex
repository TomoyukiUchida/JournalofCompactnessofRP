...
%\section{Compactness of sets of regular patterns}\label{subsec:char_union}
...
that $\RPatkei$ has compactness with respect to language containment, we establish some Lemmas, Theorem and Corollaries.}
...
%Because, for any $i$ ($1\leq i\leq 5$), $\sharp (W \cap \{a_{i}c \mid c \in \Sigma\}) \leq 2$ and $\sharp (W \cap \{cb_{i} \mid c \in \Sigma\}) \leq 2$, 
...
Let $\Sigma$ be {\color{red} an alphabet} with $\sharp \Sigma \ge 3$ and $p,q$ regular patterns.
