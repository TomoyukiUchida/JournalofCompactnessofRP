...
\begin{lem}[Sato et al.(Lemma 10, \cite{Sato1})]\label{Sato1:Lemma10}
    ...
    {\color{red} Let $p,~q$ be regular patterns in $\RPat_{\Sigma\cup X}$
...
\begin{lem}[Sato et al.(Lemma 13, \cite{Sato1})]\label{Sato1:Lemma13}
    ...
    Let $p = p_{1}AwxwBp_{2}$ and $q = q_{1}AwBq_{2}$ be regular patterns in {\color{red}$\RPat_{\Sigma\cup X}$} that satisfy the following three conditions:
    \[
        \begin{tabular}{ll}
...
{\color{red} The following example~\ref{counter-example4Theorem11} in \cite{Sato1} illustrates the failure of Theorem~\ref{Sato1:Theorem11} under the condition of $\sharp\Sigma \leq 2k$, in accordance with Lemma~\ref{Sato1:Lemma13}.} 
