...
{\color{red} In this subsection, if $D = \{ ya, bc, dy \} \subset \RPat_{\Sigma\cup X}$ is not maximally generalized with respect to $(p,q)$, then Lemmas \ref{lem:addpart}, \ref{lem:oneside_i} and \ref{lem:oneside_ii} are trivially reducible to Lemma \ref{lem:twovariables}.
 Then, in Lemmas \ref{lem:addpart}, \ref{lem:oneside_i} and \ref{lem:oneside_ii} we consider the case where $D$ is maximally generalized with respect to $(p,q)$.}
