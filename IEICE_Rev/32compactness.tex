...
\end{lem}
  ...
  If $A=dy_{2}$ and $C=y_{1}a$ hold, $B=bc$ and the following six conditions hold: for $y_{1}^{\prime},y_{2}^{\prime}\in X$,
  \begin{align*}
  ...
  \end{align*}
  If $p_{2} \preceq y_{2}^{\prime}wbcw^{\prime}y_{1}aq_{2}$ of (1') and $p_{1} \preceq q_{1}dy_{2}wbcw^{\prime}y_{1}^{\prime}$ of (3) hold, let $q^{\prime}_{1}=q_{1}d,~q^{\prime}_{2}=y_{2}wbcw^{\prime}y_{1},~q^{\prime}_{3}=aq_{2}$.
  From $p_{2} \preceq y_{2}^{\prime}wbcw^{\prime}y_{1}aq_{2}$ and $p_{1} \preceq q_{1}dy_{2}wbcw^{\prime}y_{1}^{\prime}$, $p_{1} \preceq q^{\prime}_{1}q^{\prime}_{2}$ and $p_{2} \preceq q^{\prime}_{2}q^{\prime}_{3}$ hold. From Theorem~\ref{Sato1:Lemma9}, $p \preceq q$ holds. It contradicts the assumption.
  If $p_{2} \preceq y_{2}^{\prime}wbcw^{\prime}y_{1}aq_{2}$ of (1') and $p_{1} \preceq q_{1}dy_{2}wbcw^{\prime}$ of (3) (resp. $p_{2} \preceq wbcw^{\prime}y_{1}aq_{2}$ of (1') and $p_{1} \preceq q_{1}dy_{2}wbcw^{\prime}y_{1}^{\prime}$ of (3)) hold, let $q^{\prime}_{1}=q_{1}d$, $q^{\prime}_{2}=y_{2}wbcw^{\prime}$, $q^{\prime}_{3}=y_{1}aq_{2}$ (resp. $q^{\prime}_{1}=q_{1}dy_{2}$, $q^{\prime}_{2}=wbcw^{\prime}y_{1}$, $q^{\prime}_{3}=aq_{2}$). These imply $p_{1} \preceq q^{\prime}_{1}q^{\prime}_{2}$ and $p_{2} \preceq q^{\prime}_{2}q^{\prime}_{3}$. It also contradicts the assumption.
  Thus, if $A=dy_{2}$ and $C=y_{1}a$ hold, we have the following conditions:
  \begin{align*}
    \textrm{(1)}~& p_{1} \preceq q_{1} & \textrm{(1')}~& p_{2} \preceq wbcw^{\prime}y_{1}aq_{2}\\
    \textrm{(2)}~& p_{1} \preceq q_{1}dy_{2}w & \textrm{(2')}~& p_{2} \preceq w^{\prime}y_{1}aq_{2} \\
    \textrm{(3)}~& p_{1} \preceq q_{1}dy_{2}wbcw^{\prime} & \textrm{(3')}~& p_{2} \preceq q_{2}
  \end{align*}
  ...
  If a variable symbol appears in $q^{\prime}_{2}$, from Theorem~\ref{Sato1:Lemma9}, $p \preceq q$ holds.
