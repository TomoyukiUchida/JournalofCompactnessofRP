...
\end{lem}
  ...
  \begin{enumerate}
  \item[(i)] $q=q_{1}AwBw^{\prime}Cq_{2}$, where $\{ A,B,C \} = \{ y_{1}a,bc,dy_{2} \}$ for distinct variable symbols $y_{1}, y_{2}\in X$, and each of $w, w^{\prime}$ is either an empty string or a regular pattern on $\Sigma\cup X$.
  \item[(ii)] $q=q_{1}AwBq_{2}$, where $\{ A,B \} = \{ y_{1}ay_{2},bc \}$ ($a = d$) for distinct variable symbols $y_{1}, y_{2}\in X$, and $w$ is either an empty string or a regular pattern on $\Sigma\cup X$.
  \item[(iii)] $q=q_{1}AwBq_{2}$, where $\{ A,B \} = \{ dy_{1}a,bc \}$ for a variable symbol $y_{1}\in X$ and $w$ is either an empty string or a regular pattern on $\Sigma\cup X$.
  
  \end{enumerate}
  
  Firstly, we show this lemma for the case (i).
  ...
  \end{align*}
  When $p_{2} \preceq wy_{1}aw^{\prime}bcq_{2}$ of (1') holds, let $q^{\prime}_{1}=q_{1}dy_{2},~q^{\prime}_{2}=wy_{1}aw^{\prime},~q^{\prime}_{3}=bcq_{2}$.
  Since $p_{1} \preceq q_{1}dy_{2}wy_{1}aw^{\prime}$ holds from (3), we have $p_{1} \preceq q^{\prime}_{1}q^{\prime}_{2}$ and $p_{2} \preceq q^{\prime}_{2}q^{\prime}_{3}$. 
  When that $p_{2} \preceq y_{2}^{\prime}wy_{1}aw^{\prime}bcq_{2}$ of (1') holds,
  let $q^{\prime}_{1}=q_{1}d,~q^{\prime}_{2}=y_{2}wy_{1}aw^{\prime},~q^{\prime}_{3}=bcq_{2}$.
  Since $p_{1} \preceq q_{1}dy_{2}wy_{1}aw^{\prime}$ holds from (3), we have $p_{1} \preceq q^{\prime}_{1}q^{\prime}_{2}$ and $p_{2} \preceq q^{\prime}_{2}q^{\prime}_{3}$.
  In both cases, from Theorem~\ref{Sato1:Lemma9}, $p \preceq q$ holds. It contradicts the assumption.

  Similarly, any case of $(A, B, C) = (bc, y_{1}a, dy_{2})$, $(y_{1}a, dy_{2}, bc)$, $(bc, dy_{2}, y_{1}a)$ contradicts the assumption.
  %
  ...
  From \textit{Claim} 1, we have $B=bc$. If $(A, B, C) = (dy_{2}, bc, y_{1}a)$ holds, the following conditions hold: for $y_{1}^{\prime},y_{2}^{\prime}\in X$,
  \begin{align*}
  ...
  \end{align*}
  When $p_{2} \preceq y_{2}^{\prime}wbcw^{\prime}y_{1}aq_{2}$ of (1') and $p_{1} \preceq q_{1}dy_{2}wbcw^{\prime}y_{1}^{\prime}$ of (3) hold, let $q^{\prime}_{1}=q_{1}d,~q^{\prime}_{2}=y_{2}wbcw^{\prime}y_{1},~q^{\prime}_{3}=aq_{2}$.
  Then, $p_{1} \preceq q^{\prime}_{1}q^{\prime}_{2}$ and $p_{2} \preceq q^{\prime}_{2}q^{\prime}_{3}$ hold.
  When $p_{2} \preceq y_{2}^{\prime}wbcw^{\prime}y_{1}aq_{2}$ of (1') and $p_{1} \preceq q_{1}dy_{2}wbcw^{\prime}$ of (3) (resp. $p_{2} \preceq wbcw^{\prime}y_{1}aq_{2}$ of (1') and $p_{1} \preceq q_{1}dy_{2}wbcw^{\prime}y_{1}^{\prime}$ of (3)) hold, let $q^{\prime}_{1}=q_{1}d$, $q^{\prime}_{2}=y_{2}wbcw^{\prime}$, $q^{\prime}_{3}=y_{1}aq_{2}$ (resp. $q^{\prime}_{1}=q_{1}dy_{2}$, $q^{\prime}_{2}=wbcw^{\prime}y_{1}$, $q^{\prime}_{3}=aq_{2}$). These imply $p_{1} \preceq q^{\prime}_{1}q^{\prime}_{2}$ and $p_{2} \preceq q^{\prime}_{2}q^{\prime}_{3}$.
  In all of the above cases, from Theorem~\ref{Sato1:Lemma9}, $p \preceq q$ holds. It contradicts the assumption.
  
  Thus, if $(A, B, C) = (dy_{2}, bc, y_{1}a)$ holds, $p_{2} \preceq wbcw^{\prime}y_{1}aq_{2}$ of (1') and $p_{1} \preceq q_{1}dy_{2}wbcw^{\prime}$ of (3) hold.
  From (2), for some $p^{\prime}_{1}$ and $p^{\prime\prime}_{1}$, let $p_{1}=p^{\prime}_{1}p^{\prime\prime}_{1}$, where $p^{\prime}_{1} \preceq q_{1}d$ and $p^{\prime\prime}_{1} \preceq y_{2}w$. 
  From $p_{2} \preceq wbcw^{\prime}y_{1}aq_{2}$ of (1'), we have $p=p_{1}xp_{2}=p^{\prime}_{1}p^{\prime\prime}_{1}xp_{2} \preceq q_{1}dp^{\prime\prime}_{1}xwbcw^{\prime}y_{1}aq_{2}=q \{ y_{2}:=p^{\prime\prime}_{1}x \}$.
  Thus, $p \{ x := xy \} \preceq q \{ y_{2}:=p^{\prime\prime}_{1}xy \}$ holds. It contradicts the assumption.
  %
  ...
  Below, we suppose that $(A, B, C) = (y_{1}a, bc, dy_{2})$ holds.
...
\noindent
Thus, the case of $|w| \geq |w^{\prime}| + 3$ contradicts \textit{Claim} 4. 

\begin{figure}[t]
  \begin{center}
    \includegraphics[scale=0.45]{figs/w=w_1.eps}
    \caption{Subcase $|w^{\prime}| = |w^{\prime\prime}|$ of (ii) of \textit{Claim} 4 (Lemma~\ref{追加部分})}\label{追加部分7}
    \bigskip
    \includegraphics[scale=0.45]{figs/w=w_1+1.eps}
    \caption{Subcase $|w^{\prime}| = |w^{\prime\prime}| + 1$ of (ii) of \textit{Claim} 4 (Lemma~\ref{追加部分})}\label{追加部分8}
    %\includegraphics[scale=0.35]{figs/w=w_1+2.png}
    %\caption{Subcase $|w^{\prime}| = |w^{\prime\prime}| + 2$ of (ii) of \textit{Claim} 4 (Lemma~\ref{追加部分})}\label{追加部分9}
  \end{center}
\end{figure}
...
\begin{figure}[t]
  \begin{center}
    ...
    \caption{Case $|w^{\prime\prime}| + 2 \le |w^{\prime}| \le 2|w^{\prime\prime}| - 1$ of (iii) of \textit{Claim} 4 (Lemma~\ref{追加部分})}\label{w1+3}
  \end{center}
\end{figure}
...
\begin{figure}[t]
  \begin{center}
    ...
    \caption{Subcase $|w^{\prime}| = 2|w^{\prime\prime}|$ of (iv) of \textit{Claim} 4 (Lemma~\ref{追加部分})}\label{追加部分14}
    \bigskip
    \includegraphics[scale=0.45]{figs/w=2w_1+1.eps}
    \caption{Subcase $|w^{\prime}| = 2|w^{\prime\prime}| + 1$ of (iv) of \textit{Claim} 4 (Lemma~\ref{追加部分})}\label{追加部分13}
    \bigskip
    \includegraphics[scale=0.45]{figs/w=2w_1+2.eps}
    \caption{Subcase $|w^{\prime}| = 2|w^{\prime\prime}| + 2$ of (iv) of \textit{Claim} 4 (Lemma~\ref{追加部分})}\label{追加部分12}
    \bigskip
    \includegraphics[scale=0.45]{figs/w=2w_1+3.eps}
    \caption{Subcase $|w^{\prime}| = 2|w^{\prime\prime}| + 3$ of (iv) of \textit{Claim} 4 (Lemma~\ref{追加部分})}\label{追加部分11}
...
\begin{figure}[t]
  \begin{center}
    ...
    \caption{Case $2|w^{\prime\prime}| + 4 \leq |w^{\prime}|$ of (v) of \textit{Claim} 4 (Lemma~\ref{追加部分})}\label{2w1+5}
  \end{center}
\end{figure}
