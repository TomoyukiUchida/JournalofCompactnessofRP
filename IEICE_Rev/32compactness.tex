...
We suppose that $(A, B) = (dy_{1}a, bc)$, i.e., $q = q_{1}dy_{1}awbcq_{2} $ holds.
  ...
  Then, the following conditions must be satisfied: For $y_{1}^{\prime}, y_{2}^{\prime} \in X$,
  \begin{align*}
    \textrm{(1)}~& p_{1} \preceq q_{1}\mbox{ or} p_{1} \preceq q_{1}y_{1}^{\prime} XS& \textrm{(1')}~& p_{2} \preceq y_{2}wbcq_{2}, \\
...
\begin{align*}
  \textrm{(1)}~& p_{1} \preceq q_{1}d \mbox{~or} p_{1} \preceq q_{1}dy_{1}^{\prime} & \textrm{(1')}~& p_{2} \preceq cq_{2}, \\
  %&  p_{1} \preceq q_{1}dy_{1}^{\prime}, & & \\
