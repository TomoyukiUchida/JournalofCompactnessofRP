...
\begin{proof}
  We will prove this proposition by induction on the length of $w$ {\color{black}(i.e., $|w|$)}.
  \begin{itemize}
  \item $|w| = 0,1,2,\mbox{\color{black}~or~}3$: it is straightforward to observe that $\pair{b}{c} \in \{\pair{a}{d}, \pair{d}{a}\}$.
...
Without loss of generality, {\color{black} we assume that $|w| \geq |w^{\prime}|$, since the case $|w| < |w^{\prime}|$ similarly leads to} the same conclusion that $\pair{a}{d} \in \{\pair{b}{c}, \pair{c}{b}\}$.
{\color{black}Hence, we have $\pair{b}{c} \in \{\pair{a}{d}, \pair{d}{a}\}$.}
\begin{itemize}
...
Because {\color{black}$|w| - (|uda| + |bcu|) = 2|w^{\prime}| - |w| \ge 1$}, there exists a constant string $u^{\prime}$ of length $2|w^{\prime}| - |w|$ such that $w = udau^{\prime}bcu$.
