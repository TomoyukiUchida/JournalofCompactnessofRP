...
{\color{red}In this paper, this study revisits and corrects the compactness theorem for regular pattern languages originally proposed by Sato et al.~\cite{Sato1} by identifying an error in their proof and providing a revised argument under additional conditions. Furthermore, we establish that for the subclass of non-adjacent regular patterns, finite unions can be efficiently learned under weaker constraints on constant symbols than those required in the general case. 
